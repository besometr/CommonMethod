////////////////////////////////////////////////////////////////////////////////
// Серверный модуль объекта Документ.споГруз
////////////////////////////////////////////////////////////////////////////////
...
// Создает и записывает объект споГруз с выполнением метода ПоменятьГородаМестами
//
// Параметры:
...
Функция СтруктураОбъекта(СтруктураРеквизитовДляПоиска = Неопределено, ТекстОшибки = "", Отказ = Ложь) Экспорт
	...
	// Перенаправка в модуль менеджера объекта
	Возврат Документы.споГруз.СтруктураОбъекта(СтруктураРеквизитовДляПоиска, ТекстОшибки, Отказ);
...
Функция СтруктураСтрокиТабличнойЧастиОбъекта(ИмяТабличнойЧасти, ТекстОшибки = "", Отказ = Ложь) Экспорт
	...
	// Перенаправка в модуль менеджера объекта
	Возврат Документы.споГруз.СтруктураСтрокиТабличнойЧастиОбъекта(ИмяТабличнойЧасти, ТекстОшибки, Отказ);
...
Функция РеквизитыОбъекта(МассивСсылок, СтруктураРеквизитов = Неопределено) Экспорт
	...
	// Перенаправка в модуль менеджера объекта
	Возврат Документы.споГруз.РеквизитыОбъекта(МассивСсылок, СтруктураРеквизитов);
...
Функция СоздатьОбъект(СтруктураОбъекта, ДополнительныеСвойства = Неопределено, ПараметрыЗаписи = Неопределено, ТекстОшибки = "", Отказ = Ложь) Экспорт 
	...
	Возврат Документы.споГруз.СоздатьОбъект(СтруктураОбъекта, ДополнительныеСвойства, ПараметрыЗаписи, ТекстОшибки, Отказ);
...
Функция ОбновитьОбъект(Ссылка,
	...
	// Перенаправка в модуль менеджера объекта
	Возврат Документы.споГруз.ОбновитьОбъект(Ссылка,
												СтруктураИзмененийОбъекта,
...
Функция СоздатьОбъектБезЗаписи(СтруктураОбъекта, ДополнительныеСвойства = Неопределено, ТекстОшибки = "", Отказ = Ложь) 
	...
	// Перенаправка в модуль менеджера объекта
	Возврат Документы.споГруз.СоздатьОбъектБезЗаписи(СтруктураОбъекта, ДополнительныеСвойства, ТекстОшибки, Отказ);
...
Функция ОбновитьОбъектБезЗаписи(Ссылка, 
	...
	// Перенаправка в модуль менеджера объекта	
	Возврат Документы.споГруз.ОбновитьОбъектБезЗаписи(Ссылка,
														СтруктураИзмененийОбъекта,
														ДополнительныеСвойства,
														ОчищатьТЧ,
														ТекстОшибки,
...
Функция ЗаписатьОбъект(Объект, ПараметрыЗаписи = Неопределено, ТекстОшибки = "", Отказ = Ложь)
	...
	// Перенаправка в модуль менеджера объекта
	Возврат Документы.споГруз.ЗаписатьОбъект(Объект, ПараметрыЗаписи, ТекстОшибки, Отказ);
