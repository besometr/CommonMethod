...
Функция СоздатьОбъект(СтруктураОбъекта, ДополнительныеСвойства = Неопределено, ПараметрыЗаписи = Неопределено, ТекстОшибки = "", Отказ = Ложь) Экспорт 
	...
	Ссылка = ОбщиеМетодыОбъектов_ШаблонМодуляМенеджера.СоздатьОбъект(СтруктураОбъекта, ДополнительныеСвойства, ПараметрыЗаписи, ТекстОшибки, Отказ);
...
Функция ОбновитьОбъект(Ссылка,
	...
	// Перенаправка в модуль менеджера объекта
	Ссылка = ОбщиеМетодыОбъектов_ШаблонМодуляМенеджера.ОбновитьОбъект(Ссылка,
														СтруктураИзмененийОбъекта,
...
Функция СоздатьОбъектБезЗаписи(СтруктураОбъекта, ДополнительныеСвойства = Неопределено, ТекстОшибки = "", Отказ = Ложь) 
	...
	// Перенаправка в модуль менеджера объекта
	Объект = ОбщиеМетодыОбъектов_ШаблонМодуляМенеджера.СоздатьОбъектБезЗаписи(СтруктураОбъекта, ДополнительныеСвойства, ТекстОшибки, Отказ);
...
Функция ОбновитьОбъектБезЗаписи(Ссылка, 
	...
	// Перенаправка в модуль менеджера объекта	
	Объект = ОбщиеМетодыОбъектов_ШаблонМодуляМенеджера.ОбновитьОбъектБезЗаписи(Ссылка,
														СтруктураИзмененийОбъекта,
														ДополнительныеСвойства,
														ОчищатьТЧ,
														ТекстОшибки,
...
Функция ЗаписатьОбъект(Объект, ПараметрыЗаписи = Неопределено, ТекстОшибки = "", Отказ = Ложь)
	...
	// Перенаправка в модуль менеджера объекта
	Ссылка = ОбщиеМетодыОбъектов_ШаблонМодуляМенеджера.ЗаписатьОбъект(Объект, ПараметрыЗаписи, ТекстОшибки, Отказ);
